...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    public LoginAdmin() {
        initComponents();
        tf_psw.setBackground(new Color(0,0,0,0));
        tf_mail.setBackground(new Color(0,0,0,0));
    ...
    private void initComponents() {
        ...
        tf_psw.setForeground(new java.awt.Color(255, 255, 255));
        ...
        gada.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gadaMouseClicked(evt);
            }
        });
        ...
        btn_login.setForeground(new java.awt.Color(37, 51, 60));
        ...
        gambarlogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/loginadmin.jpg"))); // NOI18N
    ...
    private void button_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_loginMouseClicked
        ...
        try {
            String sql = "select*from admin where email='"+mail+"'and password ='"+psw+"'";
            stat = conn.createStatement();
            rs = stat.executeQuery(sql);
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Selamat Datang Admin >.<");
                String admin = tf_mail.getText();
            ...
            JOptionPane.showMessageDialog(this, "gagal masuk karena"+ e);
        }
    ...
    private void button_loginMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_loginMouseExited
        // TODO add your handling code here:
        button_login.setBackground(Color.white);
        btn_login.setForeground(new Color(37,51,60));
    ...
    private void gadaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gadaMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_gadaMouseClicked
