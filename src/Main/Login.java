...
public class Login extends javax.swing.JFrame {
    ...
    private void button_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button_loginMouseClicked
        ...
        try {
            String sql = "select*from registrasi where email='"+mail+"'and password ='"+psw+"'";
            stat = conn.createStatement();
            rs = stat.executeQuery(sql);
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Selamat Datang "+mail);
                //
                    String Eemail = tf_mail.getText();
                    new MainUtama(Eemail).setVisible(true);
                    this.dispose();
            }else{
